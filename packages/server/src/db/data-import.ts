  ...
  for (const raw of data) {
    ...
    try {
      ...
      const input = {
        ...
        minDamage: item.minDamage as number | undefined,
        maxDamage: item.maxDamage as number | undefined,
        minHealing: item.minHealing as number | undefined,
        maxHealing: item.maxHealing as number | undefined,
        hitsPerCast: item.hitsPerCast as number | undefined,
  ...
  for (const raw of data) {
    ...
    try {
      ...
      const input = {
        ...
        armorClassModifier: item.armorClassModifier as number | undefined,
        damageReductionModifier: item.damageReductionModifier as number | undefined,
        criticalChanceModifier: item.criticalChanceModifier as number | undefined,
        dodgeModifier: item.dodgeModifier as number | undefined,
        magicResistance: item.magicResistance as number | undefined,
        healingReceived: item.healingReceived as number | undefined,
        perceptionModifier: item.perceptionModifier as number | undefined,
        stealthModifier: item.stealthModifier as number | undefined,
        spellcastingModifier: item.spellcastingModifier as number | undefined,
        lockpickingModifier: item.lockpickingModifier as number | undefined,
        strengthModifier: item.strengthModifier as number | undefined,
        dexterityModifier: item.dexterityModifier as number | undefined,
        constitutionModifier: item.constitutionModifier as number | undefined,
        intelligenceModifier: item.intelligenceModifier as number | undefined,
        wisdomModifier: item.wisdomModifier as number | undefined,
        charismaModifier: item.charismaModifier as number | undefined,
        maxHpModifier: item.maxHpModifier as number | undefined,
        maxManaModifier: item.maxManaModifier as number | undefined,
        ...
        blocksCasting: item.blocksCasting as boolean | undefined,
        blocksCombat: item.blocksCombat as boolean | undefined,
        blocksStealth: item.blocksStealth as boolean | undefined,
      };
  ...
  for (const raw of data) {
    ...
    try {
      ...
      const input = {
        ...
        spellcasting_modifier: (item.spellcasting_modifier ?? item.spellcastingModifier) as number | undefined,
        lockpicking_modifier: (item.lockpicking_modifier ?? item.lockpickingModifier) as number | undefined,
        perception_modifier: (item.perception_modifier ?? item.perceptionModifier) as number | undefined,
        critical_chance_modifier: (item.critical_chance_modifier ?? item.criticalChanceModifier) as number | undefined,
        magic_resistance_modifier: (item.magic_resistance_modifier ?? item.magicResistanceModifier) as number | undefined,
        trap_modifier: (item.trap_modifier ?? item.trapModifier) as number | undefined,
        ac_modifier: (item.ac_modifier ?? item.acModifier) as number | undefined,
        damage_resistance_modifier: (item.damage_resistance_modifier ?? item.damageResistanceModifier) as number | undefined,
        dodge_modifier: (item.dodge_modifier ?? item.dodgeModifier) as number | undefined,
        damage_modifier: (item.damage_modifier ?? item.damageModifier) as number | undefined,
        energy_modifier: (item.energy_modifier ?? item.energyModifier) as number | undefined,
        speed_modifier: (item.speed_modifier ?? item.speedModifier) as number | undefined,
        defense_modifier: (item.defense_modifier ?? item.defenseModifier) as number | undefined,
        healing_modifier: (item.healing_modifier ?? item.healingModifier) as number | undefined,
        vision_modifier: (item.vision_modifier ?? item.visionModifier) as number | undefined,
  ...
  for (const raw of data) {
    ...
    try {
      ...
      const input = {
        ...
        darkness_level: item.darkness_level as number | undefined,
        ...
        if (existingDoor) {
          ...
          try {
            await doorRepo.updateDoor(existingDoor.id, {
              ...
              passageMessageArrival: door.passageMessageArrival as string | undefined,
  ...
  for (const raw of data) {
    ...
    try {
      ...
      const templateInput: Record<string, unknown> = {
        ...
        deathMessage: item.deathMessage,
        primaryFactionId,
