...
function gatherFormData(): Partial<Spell> {
  ...
  return {
    ...
    minDamage: parseInt((document.getElementById('spell-min-damage') as HTMLInputElement).value) || null,
    maxDamage: parseInt((document.getElementById('spell-max-damage') as HTMLInputElement).value) || null,
    minHealing: parseInt((document.getElementById('spell-min-healing') as HTMLInputElement).value) || null,
    maxHealing: parseInt((document.getElementById('spell-max-healing') as HTMLInputElement).value) || null,
